...
#
# Created: Fri Dec 10 09:39:19 2010
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.file_Print_action.setObjectName(_fromUtf8("file_Print_action"))
        self.file_exit_action = QtGui.QAction(MainWindow)
        self.file_exit_action.setObjectName(_fromUtf8("file_exit_action"))
        self.edit_Copy_action = QtGui.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_copy.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.edit_Copy_action.setIcon(icon2)
        self.edit_Copy_action.setObjectName(_fromUtf8("edit_Copy_action"))
        self.edit_SelectAll_action = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../../.designer/backup/image8")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.edit_SelectAll_action.setIcon(icon3)
        self.edit_SelectAll_action.setObjectName(_fromUtf8("edit_SelectAll_action"))
        self.edit_FindAction = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_find.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.edit_FindAction.setIcon(icon4)
        self.edit_FindAction.setObjectName(_fromUtf8("edit_FindAction"))
        self.file_ExtractCHMAction = QtGui.QAction(MainWindow)
        self.file_ExtractCHMAction.setObjectName(_fromUtf8("file_ExtractCHMAction"))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_add_bookmark.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_font_increase.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_Increase_font_size_action.setIcon(icon6)
        self.view_Increase_font_size_action.setObjectName(_fromUtf8("view_Increase_font_size_action"))
        self.view_Decrease_font_size_action = QtGui.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_font_decrease.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_Decrease_font_size_action.setIcon(icon7)
        self.view_Decrease_font_size_action.setObjectName(_fromUtf8("view_Decrease_font_size_action"))
        self.view_norm_font_size_action = QtGui.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_font_norm.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_norm_font_size_action.setIcon(icon8)
        self.view_norm_font_size_action.setObjectName(_fromUtf8("view_norm_font_size_action"))
        self.view_View_HTML_source_action = QtGui.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_view_source.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_View_HTML_source_action.setIcon(icon9)
        self.view_View_HTML_source_action.setObjectName(_fromUtf8("view_View_HTML_source_action"))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_locate_in_content.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.view_Locate_in_contents_action.setIcon(icon10)
        self.view_Locate_in_contents_action.setObjectName(_fromUtf8("view_Locate_in_contents_action"))
        self.view_Set_encoding_action = QtGui.QAction(MainWindow)
        self.view_Set_encoding_action.setObjectName(_fromUtf8("view_Set_encoding_action"))
        self.file_Open_action = QtGui.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_open_file.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.file_Open_action.setIcon(icon11)
        self.file_Open_action.setObjectName(_fromUtf8("file_Open_action"))
        self.nav_actionBack = QtGui.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_back.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_forward.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/images/icon_home.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nav_actionHome.setIcon(icon14)
        self.nav_actionHome.setObjectName(_fromUtf8("nav_actionHome"))
        self.actionAbout = QtGui.QAction(MainWindow)
        self.actionAbout.setObjectName(_fromUtf8("actionAbout"))
        self.file_Extract_action = QtGui.QAction(MainWindow)
        self.file_Extract_action.setObjectName(_fromUtf8("file_Extract_action"))
        ...
        self.menu_File.addAction(self.file_Extract_action)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_Extract_action.setText(QtGui.QApplication.translate("MainWindow", "&Extract", None, QtGui.QApplication.UnicodeUTF8))
        self.file_Extract_action.setIconText(QtGui.QApplication.translate("MainWindow", "Extract", None, QtGui.QApplication.UnicodeUTF8))
