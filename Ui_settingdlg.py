...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        #self.check_searchengine = QtGui.QCheckBox(self.tab_3)
        #self.check_searchengine.setGeometry(QtCore.QRect(0, 410, 243, 23))
        #self.check_searchengine.setObjectName("check_searchengine")
...
"支持正则表达式搜索（python）", None, QtGui.QApplication.UnicodeUTF8))
        ...
        #self.check_searchengine.setText(QtGui.QApplication.translate("Dialog", "使用pychm库所带的搜索功能（不推荐）", None, QtGui.QApplication.UnicodeUTF8))
