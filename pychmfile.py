...
class PyChmFile(object):
    ...
    def loadFile(self,filename):
        ...
        if self.__code==None or self.__code=='':
            self.__code='utf-8'
        self.__homeurl=self.__chm.home.decode(self.__code)
    ...
    def __hascontenttable(self):
        self.__getCttTbl()
        return self.__contenttbl!=None and len(self.__contenttbl)!=0
    HasTopic=property(__hascontenttable)

    def __hasindextable(self):
        self.__getIdxTbl()
        return self.__indextbl!=None and len(self.__indextbl)!=0
